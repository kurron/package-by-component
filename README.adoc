...
== Overview
This project is an implementation of the GURPS rules using an idea from link:https://youtu.be/5OjqD-ow8GE[Modular Monoliths] where implementation of components live in their own package, exporting on a single public interface.
