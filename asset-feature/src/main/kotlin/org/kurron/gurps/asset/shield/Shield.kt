...
@Table(name = "shields", schema = "asset")
internal data class Shield(@Column("id") @Id val id: Int = 0,
                           @Column("version") @Version val version: Int = 0,
                           @Column("type") val type: String,
                           @Column("defense_bonus") val defenseBonus: Int = 0,
    ...
    companion object {
        fun randomInstance() = Shield(type = "unknown")
