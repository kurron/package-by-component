...
@Table(name = "technology", schema = "asset")
internal data class TechnologyLevel(@Column("id") @Id val id: Int = 0,
                                    @Column("version") @Version val version: Int = 0,
                                    @Column("level") val level: String,
                                    @Column("description") val description: String,
                                    @Column("starting_wealth") val startingWealth: Int = 0,
    ...
    companion object {
        fun randomInstance() = TechnologyLevel(level = "unknown", description = "unknown")
