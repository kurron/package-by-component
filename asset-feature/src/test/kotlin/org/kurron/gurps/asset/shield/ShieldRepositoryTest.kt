...
@Testcontainers
@SpringBootTest(classes = [ShieldRepositoryTest.Companion.AdditionalBeans::class])
...
class ShieldRepositoryTest {
    ...
    fun verifyCRUD() {
        ...
        assertEquals(defenseBonus, all.first().defenseBonus, "Defense Bonuses do no match!")
